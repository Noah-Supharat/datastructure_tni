...
public class BinaryTree {
    ...
    public void createTree5() {
        int[] nums = {50, 30, 70, 10, 40, 60, 20, 45, 55, 65, 25}; //bfs
    ...
    public void createTree6() {
        int[] nums = {40, 20, 70, 30, 55, 85, 25, 35, 80, 32}; //bfs
    ...
    public void find(int target) {
        ...
        if (targetNode != null) {
            if (targetNode.left != null) {
                System.out.println(target + "'s left child is " + targetNode.left.data);
            } else {
                System.out.println("No left child");
            }

            if (targetNode.right != null) {
                System.out.println(target + "'s right child is " + targetNode.right.data);
            } else {
